...
async function getTelegramName(
  bot,
  chatId
) {
...
async function sendAdRequired(
  ...
  await bot.sendMessage(
    ...
    "📢 <b>ACTIVACIÓN DE KEY FREE</b>\n\n" +
      ...
      "Cuando completes los 5 anuncios, pulsa " +

      "<b>VOLVER AL BOT</b> en la página de anuncios.",
...
export default function registerFreeKey(
  ...
  bot.on(
    ...
    async (query) => {
      ...
      // COMPATIBILIDAD
      //
      // Si todavía existe algún mensaje antiguo con este
      // callback, ya NO desbloqueamos nada desde aquí.
      //
      // El desbloqueo correcto se hace mediante:
      //
      // /start adscompleted
      //
      // enviado por el WebApp.
      // ======================================================
      ...
      if (
        ...
        await bot.answerCallbackQuery(
...

          {
            ...
            text:
              "Completa los anuncios desde el botón correspondiente.",
